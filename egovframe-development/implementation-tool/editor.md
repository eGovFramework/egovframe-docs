...
3. “Add Repository” 다이얼로그 창에 있는 Location 입력 항목에 `https://maven.egovframe.go.kr/eclipse-plugin/egovframe/5.0/eclipse버전/`을 입력하고 “OK” 버튼을 클릭한다.

   - Windows, Linux : `https://maven.egovframe.go.kr/eclipse-plugin/egovframe/5.0/e4.35/`
   - macOS : `https://maven.egovframe.go.kr/eclipse-plugin/egovframe/5.0/e4.38/`
