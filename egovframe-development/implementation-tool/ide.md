...
url: /egovframe-development/implementation-tool/ide/
menu:
  depth:
    weight: 3
...
| 구분            | 메뉴                            | 소메뉴                       | 설명                                             |
| -------------- | ------------------------------ | -------------------------- | ----------------------------------------------- |
| Start          | New Web Project                |                            | New eGovFrame Web Project 생성 마법사 실행          |
...
|                | New Sequence Diagram           |                            | New Sequence Diagram 생성 마법사 실행               |
| Implementation | New Mapper Configuration       |                            | New eGovFrame SQL Mapper Configuration 생성 마법사 실행 |
|                | New Mapper                     |                            | New eGovFrame SQL Mapper 생성 마법사 실행           |
|                | Show DBIO Search View          |                            | DBIO Search View 표시                            |
|                | Add eGovFrame Common Component |                            | eGovFrame 공통컴포넌트 조립도구 마법사 실행              |
|                | XMI Based CodeGen              |                            | XMI 기반 eGovFrame Code Generation 실행            |
|                | New Batch Job                  |                            | New eGovFrame Batch Job 생성 마법사 실행             |
...
**※ 프로젝트 생성 후 pom.xml파일의 리포지토리 정보를 각 프로젝트의 개발환경 정보로 변경한다.**
...
2. 프로젝트명과 메이븐 설정에 필요한 값들을 입력하고 **Next**를 클릭한다.
   ...
   ![Web Project 생성 2](./images/4th-boot-web.png)
3. 예제 소스 파일 생성 여부를 체크하고 **Finish**를 클릭한다.

   ![Web Project 생성 3](./images/4th-boot-web-example.png)

**Create a eGovFrame Boot Web Project 페이지**
