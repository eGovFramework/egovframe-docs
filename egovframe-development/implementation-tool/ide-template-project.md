...
url: /egovframe-development/implementation-tool/ide/template-project-wizard/
menu:
  depth:
    weight: 3
    parent: "ide"
    identifier: "template-project-wizard"
---
...
* Common All-in-one : 웹 공통컴포넌트 253종 전체의 설치를 돕는 생성 마법사를 제공

## 사용법

1. eGovFrame Perspective를 적용하고, 템플릿 프로젝트 생성 마법사를 연다. 아래 3가지 방법 중 하나를 따른다.
   - 메뉴 표시줄에서 **File** > **New** > **eGovFrame Template Project**를 선택한다.
   - **Ctrl+N** 단축키를 이용하여 새로 작성 마법사를 실행한 후 **eGovFrame** > **eGovFrame Template Project**을 선택하고 **Next**를 클릭한다.
   - 상단 메뉴에서 **eGovFrame** > **Start** > **New Template Project**를 선택한다.
...
3. 프로젝트 명과 메이븐 설정에 필요한 값들을 입력하고 **Finish**를 클릭한다.
   ...
   ![사용법 3](./images/new-template-wizard3.png)
4. 서버를 실행하여 생성한 템플릿 프로젝트를 확인한다.

   1. 단순 홈페이지
      ![Simple Homepage](./images/simple-homepage-main.png)
   2. 포털 사이트
