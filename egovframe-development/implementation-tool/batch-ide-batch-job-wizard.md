...
* 배치 작업 구성 항목 별 설명
  ...
  | 항목     | 설명                                                                                | 항목의 하위 구성 요소                                                                                                                                                   |
  | -------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | [Job](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:job_info_mgmt)      | 배치 전반적 프로세스를 포괄하고 있는 객체                                           | Job ID, Restartable, [Job Listeners](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:listener_mgmt#배치_작업_파일_생성시_job_listener_적용)                                                                                                                                      |
  | [Step](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:step_info_mgmt)     | 배치 실행시 Job 내부에서 각 단계별로 분리되어 독립적으로 일어나는 하나의 프로세스   | Step Type, Step ID, next, [Reader](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:job_reader_mgmt#배치_작업_파일_생성시_job_reader_적용), [Writer](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:job_writer_mgmt#배치_작업_파일_생성시_job_writer_적용), Commit-Interval, [Step Listeners](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:listener_mgmt#배치_작업_파일_생성시_step_listener_적용), [Chunk Listeners](https://www.egovframe.go.kr/wiki/doku.php?id=egovframework:dev2:bdev:imp:create_batch_job_wizard:listener_mgmt#배치_작업_파일_생성시_chunk_listener_적용), Shared values                                                               |
