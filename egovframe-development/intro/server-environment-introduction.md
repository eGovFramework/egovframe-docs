...
서버 개발환경(Windows, Unix 계열)을 [다운로드](https://www.egovframe.go.kr/home/sub.do?menuNo=104)하여 설치파일을 실행하면 서버 개발환경을 사용할 수 있다. 서버 개발환경을 설치하기 위해서는 설치 파일에 포함된 서버 개발환경 설치가이드를 참고한다.
