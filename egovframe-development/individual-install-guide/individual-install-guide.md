...
### Windows/Linux 사용자용 Eclipse Packages 이용 시 설치가이드
...
| eGovFrame | 5.0.x | https://maven.egovframe.go.kr/eclipse-plugin/egovframe/5.0/e4.35/ <br> → **eGovFrame Plug-ins** : 필요 기능 설치 | 필수 |


### macOS 사용자용 Eclipse Packages 이용 시 설치가이드
...
| Amateras Modeler | 2.2.0 | https://takezoe.github.io/amateras-update-site/ <br> → **Amateras Modeler** : Amateras Modeler <br> * 설치 후 eclipse.ini 에 –add-opens=java.desktop/java.beans=ALL-UNNAMED 추가 | 필수 |
| eGovFrame | 5.0.x | https://maven.egovframe.go.kr/eclipse-plugin/egovframe/5.0/e4.38/ <br> → **eGovFrame Plug-ins** : 필요 기능 설치 | 필수 |