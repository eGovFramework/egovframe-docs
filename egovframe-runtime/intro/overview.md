...
| 화면처리    | Internationalization | [Spring MVC](https://spring.io/) | 6.2.11 | |
| 화면처리    | MVC | [Spring](https://spring.io/) | 6.2.11 | Custom Tag 외 기능 확장 |
...
| 업무처리    | Exception Handling | [Spring](https://spring.io/) | 6.2.11 | Exception 기능 확장 |
...
| 데이터처리  | DataSource | [Spring](https://spring.io/) | 6.2.11 | |
| 데이터처리  | ORM | [Hibernate](http://www.hibernate.org/) | 5.6.15 | |
| 데이터처리  | Transaction | [Spring](https://spring.io/) | 6.2.11 | |
| 연계통합    | Naming Service Support | [Spring](https://spring.io/) | 6.2.11 | |
...
| 공통기반    | AOP | [Spring](https://spring.io/) | 6.2.11 | |
...
| 공통기반    | IoC Container | [Spring](https://spring.io/) | 6.2.11 | |
...
| 공통기반    | Property | [Spring](https://spring.io/) | 6.2.11 | |
| 공통기반    | Resource | [Spring](https://spring.io/) | 6.2.11 | |
...
- [클라우드 최적화 참조 아키텍처](./cloud-native-reference-architecture.md) — 표준프레임워크 실행환경은 화면처리, 업무처리, 데이터처리, 연계통합, 배치처리, 공통기반으로 구성된 레이어드 아키텍처를 제공한다. 이 구조는 단일 업…
