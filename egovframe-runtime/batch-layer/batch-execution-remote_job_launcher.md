...
관련 템플릿 생성 방법은 [배치 템플릿 위저드](../../egovframe-development/implementation-tool/batch-ide-batch-template-wizard.md)를 참조한다.
...
## 참고자료
- [Spring Framework 6.2 - REST Clients](https://docs.spring.io/spring-framework/reference/6.2/integration/rest-clients.html) (원격 호출 참고)
