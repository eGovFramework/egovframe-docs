...
<bean id="itemReader" class="org.springframework.batch.item.database.JdbcCursorItemReader">
   ...
   <property name="rowMapper">
      <bean class="your.domain.CustomerCreditRowMapper"/>
   </property>
</bean>
```
...
- **스프링 FlatFileItemReader**
    ...
    <bean id="itemReader" class="org.springframework.batch.item.file.FlatFileItemReader" scope="step">
        ...
        <property name="lineMapper">
            ...
            <property name="fieldSetMapper">
            <bean class="org.springframework.batch.item.file.mapping.BeanWrapperFieldSetMapper">
                <property name="targetType" value="your.domain.CustomerCredit" />	
            </bean>
            </property>
        </bean>
        </property>
    ...
    <bean id="itemReader" class="org.springframework.batch.item.file.FlatFileItemReader" scope="step">
        ...
        <property name="lineMapper">
            <bean class="org.egovframe.rte.bat.core.item.file.mapping.EgovDefaultLineMapper">
                ...
                <property name="objectMapper">
                    <bean class="org.egovframe.rte.bat.core.item.file.mapping.EgovObjectMapper">
                        <property name="type" value="your.domain.CustomerCredit" />
                        <property name="names" value="name,credit" />
                    </bean>
                </property>        
            </bean>
...
- **전자정부 EgovFlatFileItemReader**
    ...
    <bean id="itemReader" class="org.springframework.batch.item.file.FlatFileItemReader" scope="step">
        ...
        <property name="lineMapper">
            <bean class="org.egovframe.rte.bat.core.item.file.mapping.EgovDefaultLineMapper">
                <property name="lineTokenizer">
                    <bean class="org.egovframe.rte.bat.core.item.file.transform.EgovFixedByteLengthTokenizer">
...
```xml
<bean id="fileIndex-delimitedItemReader" class="org.egovframe.rte.bat.core.item.file.EgovIndexFileReader">
...
- [Spring Batch 5.2 - Item reading and writing (ItemReader)](https://docs.spring.io/spring-batch/reference/5.2/readersAndWriters.html)
