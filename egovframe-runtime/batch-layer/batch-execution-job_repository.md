...
- [Spring Batch 5.2 - Configuring a JobRepository](https://docs.spring.io/spring-batch/reference/5.2/job.html#configuringJobRepository)
- [Spring Batch 5.2 - Meta-Data Schema](https://docs.spring.io/spring-batch/reference/5.2/schema-appendix.html#metaDataSchema)
