...
![step_structure](./images/step_structure.png)
...
![chunk-oriendted_step](./images/chunk-oriendted_step.png)
...
[단순처리(Tasklet) 예제](./brte-batch_example-tasklet-mgmt.md)
...
또한, StepExecution은 주로 Step이 실행 중에 어떤 일이 일어났는지에 대한 속성들을 저장하는 저장 메커니즘 역할을 하며 commit count, rollback count, start time, end time 등의 Step 상태정보를 저장한다. ([StepExecution 속성 자세히 보기](./brte-batch-core-history-management.md))
...
![stepexecution_description](./images/stepexecution_description.png)
...
[Skip 설정 자세히 보기](./brte-batch-core-skip_repeat_retry.md)

##### Retry

[Retry 설정 자세히 보기](./brte-batch-core-skip_repeat_retry.md)

#### Step 흐름제어

[Step 흐름제어(Flow Control) 자세히 보기](./brte-batch-core-flow-control.md) 

#### Step 흐름제어

변수 선언 후 Listeners를 통해서 모든 Setp에서 사용자 정의 변수를 사용할 수 있도록 EgovStepVariableListener를 통해서 지원한다.

[Step Variable 설정 자세히 보기](./brte-batch-core-step-variable.md) 
