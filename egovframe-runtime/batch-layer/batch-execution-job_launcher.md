...
이를 이용한 jobLauncher 설정은 아래와 같다. JobExecution을 획득하기 위한 [jobRepository](./batch-execution-job_repository.md)의 설정이 필수이다.
...
## 참고자료
- [Configuring a JobLauncher](https://docs.spring.io/spring-batch/reference/5.2/job.html#configuringJobLauncher)