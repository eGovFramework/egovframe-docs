...
Spring Framework 6.2에서는 [Cache Abstraction](https://docs.spring.io/spring-framework/reference/6.2/integration/cache.html)을 통해 EhCache 등 다양한 저장소를 유연하게 사용할 수 있다. 아래에서는 EhCache 설명과 Bean 등록 방식의 사용법에 대하여 알아본다.
...
Ehcache를 Spring Application Context에 Bean으로 등록하여 사용하는 방법을 설명한다. Bean 정의는 [The IoC Container - Spring Framework 6.2](https://docs.spring.io/spring-framework/reference/6.2/core/beans.html)를 참조한다.
