...
본 문서는 [Spring Framework 6.2 - Cache Abstraction](https://docs.spring.io/spring-framework/reference/6.2/integration/cache.html)과 정합성을 유지한다.

## 개요

Spring Framework 6.2에서는 Cache 추상화(CacheManager Interface)와 Java 메소드에 적용하는 **@Cacheable** 등을 [Integration - Cache Abstraction](https://docs.spring.io/spring-framework/reference/6.2/integration/cache.html)에서 제공한다. Bean 정의는 [The IoC Container](https://docs.spring.io/spring-framework/reference/6.2/core/beans.html)를 참조한다. Spring Framework 6.2에서는 선언적 어노테이션 기반 캐싱(@Cacheable, @CacheEvict, @CachePut), JCache(JSR-107) 어노테이션, XML 기반 캐싱, 캐시 저장소 설정 등을 [Integration - Cache Abstraction](https://docs.spring.io/spring-framework/reference/6.2/integration/cache.html)에서 다룬다. Cache 추상화는 Spring의 트랜잭션기능과 유사하게 코드의 변화를 최소화하면서 Proxy를 통해 동작하게끔 한다. Cache 구현체가 아닌 Cache추상화만을 제공하며 실제 Cache Data저장소는 EhCache와 ConcurrentMap을 지원한다.
...
- [The IoC Container - Spring Framework 6.2](https://docs.spring.io/spring-framework/reference/6.2/core/beans.html): CacheManager·Bean 정의
- [Spring Framework 6.2 - Cache Abstraction](https://docs.spring.io/spring-framework/reference/6.2/integration/cache.html): 캐시 추상화, 선언적 어노테이션, 캐시 저장소 설정
- [Spring Framework 6.2 - Declarative Annotation-based Caching](https://docs.spring.io/spring-framework/reference/6.2/integration/cache/declarative-annotations.html): @Cacheable, @CacheEvict, @CachePut
- [Spring Framework 6.2 - Configuring the Cache Storage](https://docs.spring.io/spring-framework/reference/6.2/integration/cache/store-configuration.html): EhCache, ConcurrentMap 등
