...
Spring Framework은 XML Configuration을 간편하게 할 수 있게 하기 위해 jee 네임스페이스를 제공하고 있다. 전자정부 개발프레임워크는 Spring 6.2를 기반으로 하며, 본 가이드는 jee tag를 사용한 방식과 [The IoC Container](https://docs.spring.io/spring-framework/reference/6.2/core/beans.html) 기준으로 설명한다.
...
- [Spring Framework JndiTemplate API (6.2)](https://docs.spring.io/spring-framework/docs/6.2.x/javadoc-api/org/springframework/jndi/JndiTemplate.html)
- [Java-based Container Configuration](https://docs.spring.io/spring-framework/reference/6.2/core/beans/java.html) / [Bean Definition](https://docs.spring.io/spring-framework/reference/6.2/core/beans/definition.html) (jee 스키마의 jndi-lookup 등은 IoC Container의 Bean 정의 방식과 연동됨)
- [Java SE Guide to JNDI](https://docs.oracle.com/javase/8/docs/guide/jndi/)