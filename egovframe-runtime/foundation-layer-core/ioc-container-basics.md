...
- [Spring Framework 6.2 - Introduction to the Spring IoC Container and Beans](https://docs.spring.io/spring-framework/reference/6.2/core/beans/introduction.html)
