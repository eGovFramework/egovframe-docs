...
- [MVC Config](https://docs.spring.io/spring-framework/reference/6.2/web/servlet/mvc/config.html): Enable MVC Configuration, Interceptors, View Resolvers, Message Converters
