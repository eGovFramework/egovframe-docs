...
[Spring Framework 6.2 - WebSocket Fallback (SockJS)](https://docs.spring.io/spring-framework/reference/6.2/web/websocket.html#websocket-fallback)
...
위의 설정은 Spring MVC 에서 사용하기 위한 것으로 DispatcherServlet 설정에 포함되어져야 한다. (application context 를 계층적으로 가져갈 경우) 그러나 Spring WebSocket 이 SpringMVC 이외에도 사용할 수 있도록 제공되듯, SockJS 도 그러하다. 이는 [SockJsHttpRequestHandler](https://docs.spring.io/spring-framework/docs/6.2.x/javadoc-api/org/springframework/web/socket/sockjs/support/SockJsHttpRequestHandler.html) 를 통해서 제공된다.
...
- [WebSockets - SockJS Fallback](https://docs.spring.io/spring-framework/reference/6.2/web/websocket.html#websocket-fallback)
