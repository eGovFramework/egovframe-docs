...
관련 속성별 가능 값 정보는 [Spring Framework 6.2 - Declarative Transaction Management](https://docs.spring.io/spring-framework/reference/6.2/data-access/transaction/declarative.html) 및 tx 스키마를 참조한다.
...
- [Declarative Transaction Management](https://docs.spring.io/spring-framework/reference/6.2/data-access/transaction/declarative.html): @Transactional, \<tx:advice/\>
- [Using @Transactional](https://docs.spring.io/spring-framework/reference/6.2/data-access/transaction/declarative.html#transaction-declarative-annotations)