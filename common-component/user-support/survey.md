...
설문관리 시스템 구축 시 사용되는 설문조사 기능을 제공하며, 관리자가 설문조사를 관리할 수 있고 설문참여자가 설문에 참여하면 설문조사 결과가 자동으로 등록되도록 설계되어 있다.
...
| 설문문항 | COMTNQUSTNRQESITM | 설문문항을 조회한다. |
| 설문항목 | COMTNQUSTNRIEM | 설문항목을 조회한다. |
...
관리자가 기존에 등록된 설문조사 정보를 리스트 형태로 조회하고, 등록 버튼을 클릭하여 등록 화면으로 이동할 수 있다.
...
목록 클릭: 설문조사 상세조회 화면으로 이동한다.

### 설문조사 등록

#### 비즈니스 규칙

설문조사에 관한 기본정보를 입력하여 저장한다. 입력명 우측의 빨간* 표시는 반드시 입력해야 할 항목을 표시한다.
...
설문지정보: 설문지정보 팝업창이 열린다.
설문문항정보: 설문문항정보 팝업창이 열린다.
설문항목정보: 설문항목정보 팝업창이 열린다.
...
선택: 선택한 설문문항정보가 자동입력된다.

##### 4. 설문항목정보 등록 팝업

 ![image](./images/svy-olp-13qutnritempopup.png)

선택: 선택한 설문항목정보가 자동입력된다.

### 설문조사 수정

#### 비즈니스 규칙

입력한 설문조사 정보를 저장 처리한다. 입력명 우측의 빨간* 표시는 수정 시 반드시 입력해야 할 항목을 표시한다.
...
설문참여에 관한 기본정보를 입력하여 저장한다. 입력명 우측의 빨간* 표시는 반드시 입력해야 할 항목을 표시한다.
