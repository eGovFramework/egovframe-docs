...
설문질문관리 시스템 구축 시 사용되는 설문질문관리 기능을 제공하며, 설문조사 참여자가 설문에 참여할 때 설문질문관리 정보를 제공한다.
...
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_mysql.xml | 설문문항관리 MySQL용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_oracle.xml | 설문문항관리 Oracle용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_tibero.xml | 설문문항관리 Tibero용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_altibase.xml | 설문문항관리 Altibase용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_cubrid.xml | 설문문항관리 Cubrid용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_maria.xml | 설문문항관리 MariaDB용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_postgres.xml | 설문문항관리 PostgreSQL용 QUERY XML |
| QUERY XML | resources/egovframework/mapper/com/uss/olp/qqm/EgovQustnrQestnManage\_SQL\_goldilocks.xml | 설문문항관리 Goldilocks용 QUERY XML |
| Message properties | resources/egovframework/message/com/uss/olp/qqm/message\_ko.properties | 설문문항관리를 위한 Message properties(한글) |
| Message properties | resources/egovframework/message/com/uss/olp/qqm/message\_en.properties | 설문문항관리를 위한 Message properties(영문) |
| Idgen XML | resources/egovframework/spring/com/idgn/context-idgn-QustnrQestnManage.xml | 설문문항관리 Id생성 Idgen XML |

### 클래스 다이어그램

 ![image](./images/svy-qqm-설문질문관리_클래스다이어그램.jpg)
...
| 테이블명 | 테이블명(영문) | 비고 |
| --- | --- | --- |
| 설문관리 | COMTNQESTNRINFO | 설문관리를 조회한다. |
| 설문문항관리 | COMTNQUSTNRQESITM | 설문지 문항을 관리한다. |
...
관리자가 기존에 등록된 설문문항 정보를 리스트 형태로 조회하고, 등록 버튼을 클릭하여 등록 화면으로 이동할 수 있다.
...
|  |  |  | "QustnrQestnManage.selectQustnrQestnManageCnt" |
 ...
 ![image](./images/svy-qqm-3qustnrquestionlist.png)
...
설문문항에 관한 기본정보를 입력하여 저장한다. 입력명 우측의 빨간* 표시는 반드시 입력해야 할 항목을 표시한다.
...
| Action | URL | Controller method | QueryID |
| --- | --- | --- | --- |
| 저장 | /uss/olp/qqm/EgovQustnrQestnManageRegist.do | qustnrQestnManageRegistSubmit | "QustnrQestnManage.insertQustnrQestnManage" |

 ![image](./images/svy-qqm-6qustnrquestionregist.png)

 목록: 설문문항 목록 화면으로 이동한다.
 등록: 입력한 설문문항 정보들이 등록 처리된다.
설문지정보(제목): 설문지정보 팝업창이 열린다.

##### 2. 설문지 정보 팝업

 ![image](./images/svy-qqm-7qustnrquestionpopup.png)

선택: 선택한 설문지 정보가 자동입력된다.

### 설문질문관리 수정

#### 비즈니스 규칙

입력한 설문문항 정보를 저장 처리한다. 입력명 우측의 빨간* 표시는 수정 시 반드시 입력해야 할 항목을 표시한다.
...
| Action | URL | Controller method | QueryID |
| --- | --- | --- | --- |
| 저장 | /uss/olp/qqm/EgovQustnrQestnManageModify.do | qustnrQestnManageModifySave | "QustnrQestnManage.updateQustnrQestnManage" |

 ![image](./images/svy-qqm-4qustnrquestionmodify.png)
...
| 설문문항 삭제 | /uss/olp/qqm/EgovQustnrQestnManageDetail.do | egovQustnrQestnManageDetail | "QustnrQestnManage.deleteQustnrQestnManage" |
 ...
 ![image](./images/svy-qqm-5qustnrquestiondetail.png)
