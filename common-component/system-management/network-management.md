...
```text
  ① 네트워크목록조회 : 네트워크로 정의된 정보를 최근 등록 순서대로 조회하고, 그 결과 목록을 화면에 반영한다.
  ② 네트워크등록 : 네트워크정보를 등록하고, 등록 결과를 조회한다.
  ③ 네트워크수정 : 기 등록된 네트워크정보의 항목들을 수정한다.
  ④ 네트워크삭제 : 기 등록된 네트워크정보를 삭제한다.
  ⑤ 네트워크상세조회 : 등록된 네트워크정보를 조회한다.
```
