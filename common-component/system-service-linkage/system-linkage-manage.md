...
![시스템연계기능흐름](./images/systemcntc-function-flow.png)
...
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_altibase.xml | 시스템연계 관리를 위한 Altibase용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_cubrid.xml | 시스템연계 관리를 위한 Cubrid용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_maria.xml | 시스템연계 관리를 위한 MariaDB용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_mysql.xml | 시스템연계 관리를 위한 MySQL용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_oracle.xml | 시스템연계 관리를 위한 Oracle용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_postgres.xml | 시스템연계 관리를 위한 PostgreSQL용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_tibero.xml | 시스템연계 관리를 위한 Tibero용 Query XML |
| Query XML | resources/egovframework/mapper/com/ssi/syi/sim/EgovSystemCntc_SQL_goldilocks.xml | 시스템연계 관리를 위한 Goldilocks용 Query XML |
| Validator Rule XML | resources/egovframework/validator/validator-rules.xml | Validator Rule을 정의한 XML |
| Validator XML | resources/egovframework/validator/com/ssi/syi/sim/EgovSystemCntc.xml | 시스템연계 관리를 Validator XML |
| Message properties | resources/egovframework/message/com/ssi/syi/sim/message_en.properties | 시스템연계 관리를 위한 Message properties(영문) |
| Message properties | resources/egovframework/message/com/ssi/syi/sim/message_ko.properties | 시스템연계 관리를 위한 Message properties(한글) |
| Idgen XML | resources/egovframework/spring/com/idgn/context-idgn-SystemCntc.xml | 시스템연계 관리 Id생성 Idgen XML |

### 클래스 다이어그램

![클래스 다이어그램](./images/systemcntc-class-diagram.png)
...
![시스템연계 목록조회](./images/systemcntc-list.png)
...
시스템연계에 대한 상세내용을 등록한다. 등록이 성공하면 시스템연계목록 화면으로 이동한다.
시스템연계 등록시 선행작업으로 연계기관, 연계시스템, 연계서비스, 연계메시지, 연계메시지항목이 등록되어 있어야 한다.
...
![시스템연계 등록](./images/systemcntc-insert.png)
...
![시스템연계 수정](./images/systemcntc-update.png)
...
![시스템연계 상세 조회](./images/systemcntc-detail.png)
...
- 공통컴포넌트 참조 : [연계기관, 연계시스템, 연계서비스](./linkage-org-manage.md) 및 [연계메시지, 연계메시지항목](./linkage-message-manage.md) 
