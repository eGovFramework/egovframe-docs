...
커뮤니티 목록을 조회하는 기능으로 검색조건은 커뮤니티명에 대해서 수행된다. 커뮤니티 목록은 페이지 당 10건씩 조회되며 페이징은 10페이지씩 이루어진다.
...
커뮤니티의 속성정보를 입력한 뒤 커뮤니티를 생성한다. 생성이 성공적으로 종료되면 커뮤니티 목록조회 화면으로 이동한다.
