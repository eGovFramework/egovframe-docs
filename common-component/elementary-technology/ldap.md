...
## 설명
 ...
 LDAP조직도관리 컴포넌트에서 조직도 정보는 아래와 같이 트리형태와 차트형태 두가지로 표현한다.  
...
| DAO | egovframework.com.ext.ldapumt.service.impl.UserManageLdapDAO.java | 사용자 관리를 위한 Data Access Object |
