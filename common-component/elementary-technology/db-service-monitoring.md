...
- [HTTP서비스모니터링](./http-service-monitoring.md) — HTTP서비스모니터링은 웹 서비스(웹서버 및 WAS)가 정상적인지 주기적인 점검을 수행하고, 문제 발생 시 해당 정보를 관리자에게 통보하는 기능을 제…
...
- [파일시스템모니터링](./file-system-monitoring.md) — 파일시스템모니터링은 파일시스템 상태를 주기적으로 모니터링하는 기능을 제공한다. 모니터링하고자 하는 파일시스템은 파일시스템대상목록으로 시스템에 등록되어…
- [프로세스모니터링](./process-monitoring.md) — 프로세스모니터링은 특정 프로세스가 기동 중인지 주기적으로 점검을 수행하고, 문제 발생 시 해당 정보를 관리자에게 통보하는 기능을 제공한다. WINDO…
