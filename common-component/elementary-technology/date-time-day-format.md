...
날짜/시간 포맷 변경 기능은 다음과 같은 상황에서 활용할 수 있다.

- 화면에 표시할 날짜 형식을 변경하는 경우
- 로그 출력 형식을 통일하는 경우
- 데이터베이스 저장 형식과 화면 표시 형식을 변환하는 경우
...
입력된 날짜와 시간을 원하는 형식으로 변환하거나 정수형으로 변환하는 기능을 제공한다.
이를 통해 다양한 형식의 날짜 및 시간 데이터를 일관된 형식으로 활용할 수 있다.
...
- `String` : 지정한 포맷으로 변환된 날짜 또는 시간 문자열
- `int` : 날짜 또는 시간을 정수형으로 변환한 값
